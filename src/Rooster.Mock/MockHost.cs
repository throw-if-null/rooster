...
{
    public class MockHost : IHostedService
    {
        ...
        {
            _logger.LogInformation("MockHost started.", Array.Empty<object>());
            ...
            {
                _logger.LogError(ex, "MockHost failed with unhandled exception.", Array.Empty<object>());
            }
        }
