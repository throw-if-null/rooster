...
namespace Rooster.AppInsights
{
    public class AppInsightsHost
    {
        ...
        {
            _logger.LogInformation($"{nameof(AppInsightsHost)} started.", Array.Empty<object>());
            ...
            {
                _logger.LogError(ex, $"{nameof(AppInsightsHost)} failed.", Array.Empty<object>());
            }
        }
